...
1. Find the most recent session file in `.mindlayer/work/sessions/` by filename (YYYY-MM-DD.md, latest date wins).
...
Exclude: `work/sessions/`, `cache/`, `tmp/`, `private/`, `local.md`, `archive.md`.
