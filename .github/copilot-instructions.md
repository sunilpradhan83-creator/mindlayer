...
Use MindLayer memory files for context when they are present. Do not use `README.md` or `docs/` as machine memory input. Do not treat this adapter as a memory store. Do not modify memory files unless explicitly requested by the user.
