...
- V3 phase 1 in progress: memory-system/ folder split complete (00373e4). Dynamic Next Step queue complete (4e17d2f, 3a2ad04). Unified router system complete (460cb5e) — project router, auto-load-and-notify, Save Triggers replacing /m-save, boot reads project router at step 3. Boot cost ~950 tokens. Next: extend `/m-status` with per-file memory health scoring — stale, oversized, duplicate detection with a health score per file.
