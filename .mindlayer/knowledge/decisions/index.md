...
- ml-20260701-002 | Size-Aware Consolidation Mapping | knowledge/decisions/architecture.md | Refines ADR-0001: consolidate progress+backlog into work/current.md only under the line budget, else split to work/backlog.md.
