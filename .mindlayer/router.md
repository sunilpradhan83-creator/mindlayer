...
|---|---|---|
| `decisions.md` | Design or architecture question | "why", "how did we decide", "rationale", "design", "architecture", "reasoning", "tradeoff", "alternative", "why does X work", "why did we choose", "what was the decision on", "behavior", "rule change", "how is X implemented" |
