...
Tool adapters such as `AGENTS.md`, `CLAUDE.md`, and `.github/copilot-instructions.md` are not memory stores. They are thin instructions for using MindLayer.
...
- Keep tool-specific files thin. Do not duplicate memory into adapters.
