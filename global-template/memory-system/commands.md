...
Load this file when the user invokes any ml * command. Defines command behavior, archive execution, and retrieval strategy.
...
- `ml init` is a legacy/manual refresh alias for showing or rerunning the boot receipt while hosts migrate to automatic boot.
