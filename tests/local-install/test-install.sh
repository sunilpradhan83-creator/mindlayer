...
check assert_contains "$fresh_home/.mindlayer/principles.md" "id: template-global-principle"
check assert_contains "$fresh_home/.mindlayer/anti-patterns.md" "id: template-global-anti-pattern"
check assert_contains "$fresh_home/.mindlayer/prompts.md" "id: template-global-prompt"
check assert_contains "$fresh_home/.mindlayer/playbook.md" "id: template-global-playbook"
check assert_contains "$fresh_home/.mindlayer/principles.md" "status: template"
