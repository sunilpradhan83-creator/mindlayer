...
lint_repo() {
  ...
  # Installer — check canonical adapter template handling and executable-runtime shape.
  ...
  require_not_contains "$PROJECT_DIR/install.sh" "global_boot=" "installer removed global boot fallback"
