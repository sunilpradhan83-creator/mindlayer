...
bash "$ROOT_DIR/tests/migration/test-layout-detect.sh"
bash "$ROOT_DIR/tests/migration/test-migration-compat.sh"
bash "$ROOT_DIR/tests/migration/test-fresh-install.sh"
bash "$ROOT_DIR/tests/migration/test-runtime-authority.sh"
bash "$ROOT_DIR/tests/migration/test-adapter-guard.sh"
bash "$ROOT_DIR/tests/migration/test-migrate.sh"
