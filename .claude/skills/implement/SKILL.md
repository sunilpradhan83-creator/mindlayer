---
name: implement
description: Use when the user asks Claude to implement an ADR, execution plan, design, multi-step feature, or large change and wants parallel senior developer agents where useful.
---
...
- Implement one clearly scoped, independent slice: `senior-implementer`
- Final review pass on a non-trivial change: `code-reviewer`
