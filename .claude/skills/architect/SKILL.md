---
name: architect
description: Use when the user asks Claude to design, architect, plan, create an ADR, evaluate architecture, choose an approach, or research best practices before implementation.
---
...
- Research current external best practices, standards, and tradeoffs: `design-researcher`
- Read-only map of how the codebase and architecture actually work: `codebase-analyst`
- Synthesize the decision and execution plan after research and exploration land: `Plan`
